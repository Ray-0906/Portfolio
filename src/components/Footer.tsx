    ...
    <footer className='w-full mb-[100px] md:mb-4 pb-10' id='contact'>
      ...
      <div className='flex flex-col items-center'>
        ...
        <p className='text-white-200 md:mt-10 my-5
         text-center'>Reach out to me today and let&apos;s cook  something amazing . .</p>
         <a href="mailto:astra3716@gmail.com">
            <MagicButton title="Let's get in touch" icon={<FaLocationArrow/>} position='right'/>
         </a>
      </div>
      <div className='flex mt-16 md:flex-row flex-col justify-between items-center'>
        <p className='md:text-base text-sm md:font-normal'>Copyright &#xa9; 2024 Asraful</p>
            ...
            {socialMedia.map((profile)=>(
                <div key={ profile.id} className='w-10 h-10 cursor-pointer flex justify-center items-center backdrop-filter backdrop-blur-lg saturate-180
                 bg-opacity-75 bg-black-200 rounded-lg border border-black-300 ml-3 mt-3'>
                    <a href={profile.url}><Image src={profile.img} alt=""  width={20} height={20}/></a>
                </div>
            ))}
        </div>
      </div>
